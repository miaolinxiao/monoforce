...
do
  ...
  do
    WEIGHTS=$HOME/THESIS/monoforce/monoforce/config/tb_runs/rough/lss_temporal_2025_03_18_21_45_19/train.pth # config/weights/${TERRAIN_ENCODER}/val.pth
